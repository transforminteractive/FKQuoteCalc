...
<h1 class="plan">Select your type of transaction</h1>
 ...
 <input id="mortgageRefinance" value="V3" name="R1" onclick="set_fees(this.form,'3');payment(this.form);" type="radio"> <label for="mortgageRefinance">Mortgage Refinance</label>
	...
	<h1 class="calcs">Legal and Land Transfer Costs</h1>
		<div class="formBlock">
			<p class="calcLabel">Legal Fees (All Inclusive) <span id="fees">$1,865 + 13% HST</span></p>
			<p class="calcLabel">Your Toronto Land Transfer Tax will be <span class="calcinput" id="TorontolandTax">$0.00</span></p>
				<div style="display: block" id="TLAFINF">
					<b><font size="1">* Effective April 1, 2016 for more info please see the <a href="http://www1.toronto.ca/wps/portal/contentonly?vgnextoid=769f4b3d0e673510VgnVCM10000071d60f89RCRD&vgnextchannel=4f90ff0e43db1410VgnVCM10000071d60f89RCRD#3" target="_new">City of Toronto's website</a></font></b>
				</div>
				<!--//tlafinf-->
	...
	<h1 class="dollars">Final Closing Costs</h1>
		<div class="formBlock">
			<p class="calcLabel">Total Closing Costs: <span class="calcinput" id="totalClosingCost">$2,107.00</span></p>
			<b><font size="1">* this fee assumes no unforeseen complications or circumstances arise.</font></b><br>
